...
import {Collapse, Dropdown,Alert} from 'react-bootstrap';
    ...
    >
      <PerfectScrollbar className="deznav-scroll">         
          ...
          <div className="plus-box">
            <p className="fs-15 font-w500 mb-1">Sisplani E.I.R.L</p>
            <Alert.Link href="https://sisplani.com/" target="_blank" ><i className="las la-long-arrow-alt-right"></i></Alert.Link>
          ...
          <div className="copyright">
            ...
            <p>Made with <i className="fa fa-heart text-danger"></i> by EduardoZK</p>
          </div> 
        </PerfectScrollbar>
      </div>
    );
